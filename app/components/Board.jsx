...
export default function Board({copyDataArray, dataArray, handleMainNumbers}) {
  return (
    <div className='w-[91vw] h-[91vw] grid grid-cols-9 border-2 border-white sm:w-[460px] sm:h-[460px]'>
        {dataArray.map((singleBox, i) => <div 
                                            id='singleBox'
                                            key={i} 
                                            className='font-mono text-[1.2rem] w-[10vw] h-[10vw] sm:w-[50px] sm:h-[50px] border-[1px] border-white text-white flex justify-center items-center cursor-pointer'
